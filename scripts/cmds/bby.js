  ...
  onChat: async function ({ api, event, message, usersData }) {
    ...
    try {
      ...
      if (simpleTriggers.includes(raw)) {
        await sendTyping();
        const replies = ["ডাকো কেন 🥺 প্রেম করবা নাকি 😞", "তোর কি চোখে পড়ে না আমি মিলন বস এর সাথে ব্যাস্ত আসি😒", "ওই জান কাছে আসো 🫦👅", "আলাবু বলো সোনা 🤧", "মিলন কে দেখছো? 🥺 তাকে কোথাও খুজে পাচ্ছি না 😩", "তুমার নুনুতে উম্মাহ 🥺🤌", "বার বার Disturb করেছিস কোনো 😾, আমার বস মিলন এর সাথে ব্যাস্ত আসি 😋", "ডাকিস না, তুই পচা 😼"];
