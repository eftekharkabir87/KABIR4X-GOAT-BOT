  ...
  onChat: async function ({ api, event, message, usersData }) {
    ...
    try {
      ...
      if (simpleTriggers.includes(raw)) {
        await sendTyping();
        const replies = ["ডাকো কেন 🥺 প্রেম করবা নাকি 😞", "naw message daw mhttps://m.me/milon?text=Hi", "বার বার Disturb করেছিস কোনো 😾, আমার বস মিলন এর সাথে ব্যাস্ত আসি 😋",  "তোর কি চোখে পড়ে না আমি মিলন বস এর সাথে ব্যাস্ত আসি😒", "ওই জান কাছে আসো 🫦👅", "আলাবু বলো সোনা 🤧", "মিলন কে দেখছো? 🥺 তাকে কোথাও খুজে পাচ্ছি না 😩", "তুমার নুনুতে উম্মাহ 🥺🤌", "হ্যাঁ গো জান বলো 🙂", "ডাকিস না, তুই পচা 😼"];
